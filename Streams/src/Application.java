...
public class Application {
	...
	System.out.println("<<<<<<<<<<<BookNames Greater Than BookPrice>>>>>>>>>>");
	
	List<String> nameListGrtThan400 = ((BookService)service).getBookNames();
	nameListGrtThan400.forEach(System.out::println);
	
	System.out.println("<<<<<Sorted By Name>>>>>");
	
	
	System.out.println("Greater than");
	List<Book> bookList2 = ((BookService)service).findBookGrtThan1(500);
	bookList2.forEach(System.out::println);
	
	 System.out.println("Using Streams");
	 ((BookService)service).findBookGrtThan1(200).forEach(System.out::println);
